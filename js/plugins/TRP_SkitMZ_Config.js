 ...
 * 
 * 【更新履歴】
 * 1.18 2023/03/29 「同位置キャラ退出(デフォ値)」追加。
 * 1.16 2023/02/11 「無効:hide後に不透明度初期化」追加。
 * 1.14 2022/09/29 「立ち絵のピクチャ操作無効」追加。
 ...
 * @parent categoryAppearCommands
 *
 * @param defaultHideSamePos
 * @text 同位置キャラ退出(デフォ値)
 * @desc コマンドパラメータ「同位置キャラを退出」のデフォ値
 * @default false
 * @type boolean
 *
 * @param disableHideSamePos
 * @text 無効化:「同位置キャラ退出」
 * @desc 「同位置キャラを退出」機能を完全に無効化（誤動作防止用）
 * @default false
 * @type boolean
 *
 * @param fadeIn
