...
(() => {
    ...
    class Sprite_ExtraGauge extends Sprite_Gauge {
        ...
        isFull2() {
            return this._value <= this._maxValue * 0.2;
        }
        ...
        gaugeColor1() {
            ...
            return this.findColor(this.isFull2() ? (fullColor || color) : color, super.gaugeColor1());
        }

        gaugeColor2() {
            const fullColor = this._detail.GaugeColorFullRight;
            const color = this._detail.GaugeColorRight;
            return this.findColor(this.isFull2() ? (fullColor || color) : color, super.gaugeColor2());
        }
