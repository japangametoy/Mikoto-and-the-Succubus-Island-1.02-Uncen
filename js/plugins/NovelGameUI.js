...
(() => {
    ...
    Input.defaultGamepadMapper[8] = "control";
    Input.defaultGamepadMapper[7] = "function";
    ...
    Input.switchedGamepadMapper[8] = "control";
    Input.switchedGamepadMapper[7] = "function";
    ...
    Window_Message.prototype.updateShowFast = function() {
        ...
        if ($gameSwitches.value(202)&&$gameSwitches.value(13)) {
            if (!this._skipCounter) {
                this._skipCounter = 0;
            }
    
            this._skipCounter++;
    
            if (this._skipCounter % 3 === 0) { // 3フレームごとにスキップを実行
                this._showFast = true;
            ...
            this._showFast = false;
            this._pauseSkip = false; // スイッチがOFFのときは通常の動作に戻す
        }
    };
    ...
    Scene_Map.prototype.update = function() {
        ...
        if (USE_SKIP && Input.isTriggered(SKIP_KEY) &&$gameSwitches.value(13) ) {
            $gameSwitches.setValue(202, !$gameSwitches.value(202));  // スイッチのON/OFFを切り替え
        }
    };
    ...
    Window_Message.prototype.updateInput = function() {
        ...
        if(this.pause && $gameSwitches.value(202)){
            this.pause = false;
            if (!this._textState) {
                this.terminateMessage();
            }
