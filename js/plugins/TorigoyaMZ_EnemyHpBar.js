...
(function () {
    ...
    /* HPバーの色をカスタマイズ */
    ColorManager.enemyHpGaugeColor1 = function() {
        return "#eb5eff"; // RGB形式でカスタム色を指定
    };
    
    ColorManager.enemyHpGaugeColor2 = function() {
        return "#eb5eff"; // 同上
    };
    ...
    Sprite_Gauge.prototype.gaugeColor1 = function() {
        if (this._battler && this._battler.isEnemy()) {
            return ColorManager.enemyHpGaugeColor1(); // カスタマイズされた色を使用
        } else {
    ...
    Sprite_Gauge.prototype.gaugeColor2 = function() {
        if (this._battler && this._battler.isEnemy()) {
            return ColorManager.enemyHpGaugeColor2(); // カスタマイズされた色を使用
        } else {
