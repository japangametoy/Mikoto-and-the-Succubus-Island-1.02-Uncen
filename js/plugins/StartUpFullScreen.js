...
(()=> {
    ...
    Scene_Boot.prototype.start = function() {
        ...
        if (!DataManager.isEventTest()&&ConfigManager.startUpFullScreen) {
            Graphics._requestFullScreen();
            //ConfigManager.startUpFullScreen = true; // ここでフルスクリーンの状態を同期
        }else{
    ...
    ConfigManager.applyData = function(config) {
        ...
        this._startUpFullScreen = this.readFlag(config, 'startUpFullScreen',true);
    };
